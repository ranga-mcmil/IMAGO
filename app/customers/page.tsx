    ...
    <MainLayout>
      <div className="p-6 space-y-4">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-semibold text-maroon">Customers</h1>
        ...
        <div className="flex justify-end">
          <Input placeholder="Search customers" className="w-[250px] h-9" />
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-12 bg-white border rounded-md">
          ...
          <div className="text-center">
            <h3 className="text-sm font-medium">No customers yet</h3>
            <p className="text-xs text-gray-500 mt-1">Create your first customer</p>
          </div>
        </div>
      </div>
    </MainLayout>
