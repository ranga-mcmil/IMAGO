...
interface ShopCategoriesTableProps {
  categories: Category[]
  page: number
  perPage: number
...
export function ShopCategoriesTable({ categories, page = 1, perPage = 10, totalCategories }: ShopCategoriesTableProps) {
  ...
  return (
    <>
      ...
      <DeleteCategoryDialog
        ...
        onConfirm={() => {
          if (categoryToDelete) {
            return deleteShopCategory(categoryToDelete.id)
          }
